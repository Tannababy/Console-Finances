...
console.log(` The total number of months = ${totalMonths}`);
...
console.log(`The total amount of Profit/Loss = ${total}`);
...
for (let i = 1; i < finances.length; i++) {
  ...
  totalChanges += currentMonth - previousMonth;
}
var average = Math.round((totalChanges / (totalMonths - 1)) * 100) / 100;
